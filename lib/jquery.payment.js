(function() {
    ...
    formatCardNumber = function(e) {
        ...
        var which = e.which;
        if (which >= 1632 && which <= 1641) {
            which = which - 1584;
        }

        digit = String.fromCharCode(which);
    ...
    $.payment.fn.formatCardCVC = function() {
        ...
        this.on('keypress', function(e) {
            ...
            if (restrictNumeric(e) && restrictCVC(e)) {
                var digit = String.fromCharCode(e.which);
                var oldVal = $(this).val();
                $(this).val(oldVal + '' + digit);
            }
    ...
    $.payment.fn.formatCardExpiry = function() {
        ...
        this.on('keypress', function(e) {
            ...
            if (restrictNumeric(e) && restrictExpiry(e)) {
    ...
    $.payment.fn.formatCardNumber = function() {
        ...
        this.on('keypress', function(e) {
            ...
            if (restrictNumeric(e) && restrictCardNumber(e)) {
                var digit = String.fromCharCode(e.which);
                var oldVal = $(this).val();
                $(this).val(oldVal + '' + digit);
